            ...
            <div>
                ...
                <ul style="background-color: #ffffff" class="breadcrumb breadcrumb-transparent breadcrumb-dot my-2 p-0">
                    <li class="breadcrumb-item">
                        <a href="{{ route('storagelocations.index') }}">Lugares de Almacenamiento</a>
                    </li>
                    <li class="breadcrumb-item">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::model($storageLocation, ['method' => 'PATCH','route' => ['storagelocations.update', $storageLocation->id]]) !!}
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="code">Codigo Sernapesca</label>
